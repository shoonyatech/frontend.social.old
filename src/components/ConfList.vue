  ...
  <div>
    ...
    <div class="jobtitle">
      <div class="row">
        ...
        <div class="col-6">
          <!-- data to come -->
          <span style="float:right;" v-if="conflist.dateFrom">{{
            this.convertfromDate(conflist.dateFrom)
          }}</span>
        </div>
      </div>
      <br />
      <div class="" v-if="conflist.description">
        ...
        <div
          ...
          v-else-if="conflist.description.length > 500"
        >
          <div class="col-4">
            <more-description
              :moreDescription="conflist.description"
            ></more-description>
          </div>
          <br />
        </div>
    ...
    <!-- link to come -->
    <button class="btnDetails" @click="detailJob(conflist.link)">
      Details
    </button>
