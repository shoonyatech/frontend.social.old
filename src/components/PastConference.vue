<template>
    <div class="row mt-1">
        <div class="col-4 col-md-4 textalign textcolorgreen"><span>{{pastConf.name}}</span></div>
        <div class="col-5 col-md-5 textalign textcolorgreen"><span>{{this.convertfromDate(pastConf.dateFrom)}}</span></div>
